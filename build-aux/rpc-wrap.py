...
"""
    ...
    cw.out('if (!err.empty()) {{')
    cw.indent()
    cw.out('LOGE("picojson error: %s", err.c_str());')
    cw.dedent()
    cw.out('}}')
    cw.out()
    ...
    cw.indent()
    cw.out('LOGE("JSON-RPC request is not an Object");')
    cw.dedent()
    cw.out('}}')
    cw.out()
    ...
    cw.indent()
    cw.out('LOGE("JSON-RPC request name is not a String");')
    cw.dedent()
    cw.out('}}')
    cw.out()
    ...
    cw.indent()
    cw.out('LOGE("JSON-RPC request params is not an Object");')
    cw.dedent()
    cw.out('}}')
    cw.out()
    ...
    cw.indent()
    cw.out('LOGE("received synchronous request");')
    cw.out()
